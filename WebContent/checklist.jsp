    ...
    <div class="row container">
      ...
      <div class="row">
        <div class="col s12 m3">
          <input type="number" id="txtnumcheck" />
          <label for="txtnumcheck">Ingrese la Cantida de Check a ingresar</label>
          <a id="botoncheck" class="waves-effect waves-light btn">
              <i class="material-icons left">import_export</i>Generar</a>
        </div>
      </div>
      <div class="row">
          <div class="col s12 m5 l6">
            <form action="check" id="contenido">
